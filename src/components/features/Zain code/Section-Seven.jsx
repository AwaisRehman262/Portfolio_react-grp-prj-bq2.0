...
import "./styles-zain.css";

export const SectionSeven = () => {
  return (
    <div>
      {/* <!-- Zain's code start from here --> */}

      {/* <!-- section 5   style="background-color: lightgray;"  --> */}
      <section id="section-five-id" className="section-five">
        <svg
        ...
        <div className="sectionfivetitle">
          Our latest and easiest editor to date.
          <div className="sectiontitle-des">
            Choose our code editor for a completely customizable experience.
            With thousands of packages to choose from, you can tailor your
            editor to suit your unique coding needs. Experience the difference
            for yourself today.
          </div>
        </div>
      </section>
      <table className="section-two-table">
        <tr>
          <td className="section-two-table-item">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="80"
              width="80"
        ...
        <tr>
          ...
          <td>
            <p>Hundreds of color themes for coding and file hierarchy.</p>
          </td>
          <td>
            <p>Offers real run-time editing across all platforms.</p>
          </td>
          <td>
            <p>
              Provides quick and smooth deployment upto twenty files
              simultaneously.
            </p>
          </td>
        </tr>
      ...
      {/* <!-- section 6 --> */}
      <section id="section-six-id" className="section-six">
        <div className="sectionsixtitle">
          Our Customer's reviews.
          <div id="sectiontitle-des-id" className="sectiontitle-des">
            Take a look at a few reviews from our customers.
            <br />
            <br />
            Reviews help potential customers make informed decisions, build
            trust and credibility for a brand, and identify areas for
            improvement.
          </div>
        </div>
        <svg
      ...
      <table className="section-six-table">
        <tr>
          <td>
            {/* <!-- Graduate student --> */}
            <svg
        ...
        <tr>
          <td>
            <p>
              "Great code editor - user-friendly interface and top-notch
              features. Highly recommend!" - John S.
            </p>
          </td>
          <td>
            <p>
              "This editor improved my coding efficiency a lot. Great customer
              service too." - Sarah T.
            </p>
          </td>
          <td>
            <p>
              "Best code editor I've used. Endless customization options and
              easy navigation. Recommended to all my developer friends." - Alex
              P.
            </p>
          </td>
        </tr>
      ...
      {/* <!-- section 7 --> */}
      <section className="section-seven" id="colaborations">
        <svg
          className="bi bi-terminal-plus"
          xmlns="http://www.w3.org/2000/svg"
          height="250"
        ...
        <div className="sectionseventitle">
          Our Partnerships.
          <div className="sectiontitle-des">
            These are a few of many partnerships we have created over time.
            <br />
            Partnerships build trust and improve attitudes, helping members
            achieve more goals both internally and externally.
          </div>
        </div>
      </section>

      <table id="section-seven-table-id" className="section-seven-table">
        <tr>
          <td>
            {/* <!-- GitHub --> */}
            <svg
        ...
        <tr>
          ...
          <td>
            ...
            >
              <path
                fill="#ffffff"
                d="M223.7 141.1 167 284.2 111 141.1H14.9L120.8 390.2 82.2 480h94.2L317.3 141.1zm105.4 135.8a58.2 58.2 0 1 0 58.2 58.2A58.2 58.2 0 0 0 329.1 276.9zM394.7 32l-93 223.5H406.4L499.1 32z"
              />
            </svg>
            <p>Yahoo!</p>
          </td>
